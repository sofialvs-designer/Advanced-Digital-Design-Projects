...
A collection of advanced digital systems and hardware architectures designed in VHDL/SystemVerilog. Includes optimized finite state machines (FSM), testbenches for digital verification, and real-time data processing algorithms.

## 🛠️ General Tools & Technologies
* **Design & Synthesis:** Xilinx Vivado
* **Simulation & Verification:** Xilinx Vivado
* **Hardware Platforms:** Fpga Artix-7 Digilent Basys 3
---
## 📂 Project Index
